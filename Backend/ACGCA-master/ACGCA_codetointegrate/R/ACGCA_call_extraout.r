...
growthloopR <- function(sparms2, gparms2, r0, dim,lenvars2){
  ...
  bl=numeric(0), br=numeric(0), bt=numeric(0), bts=numeric(0), bth=numeric(0), boh=numeric(0), bos=numeric(0), bo=numeric(0), bs=numeric(0), LAI=numeric(0), egrow=numeric(0),
  ex=numeric(0), rtrans=numeric(0), nut=numeric(0))
  ...
  for(j in 1:lenvars2){
	...
	# I added these so I can assess predicted biomass relationships 
	# Added 10/15/2015
	output2$bl <-c(output2$bl, output1$bl)
	output2$br <-c(output2$br, output1$br)
	output2$bt <-c(output2$bt, output1$bt)
	output2$bts <-c(output2$bts, output1$bts)
	output2$bth <-c(output2$bth, output1$bth)
	output2$boh <-c(output2$boh, output1$boh)
	output2$bos <-c(output2$bos, output1$bos)
	output2$bo <-c(output2$bo, output1$bo)
	output2$bs <-c(output2$bs, output1$bs)
	output2$LAI <-c(output2$LAI, output1$LAI)
	output2$egrow <-c(output2$egrow, output1$egrow)
	output2$ex <-c(output2$ex, output1$ex)
	output2$rtrans <-c(output2$rtrans, output1$rtrans)
	output2$nut <-c(output2$nut, output1$nut)
	}#growth loop
